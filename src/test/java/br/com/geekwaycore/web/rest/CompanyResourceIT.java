...
public class CompanyResourceIT {
    ...
    public void createCompany() throws Exception {
        ...
        assertThat(testCompany.getIdentifier()).isEqualTo(DEFAULT_IDENTIFIER);
    ...
    public void updateCompany() throws Exception {
        ...
        assertThat(testCompany.getIdentifier()).isEqualTo(UPDATED_IDENTIFIER);
