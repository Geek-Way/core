...
export class CompanyDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('geekwaycoreApp.company.delete.question'));
...
export default class CompanyComponentsPage {
  ...
  async deleteCompany() {
    ...
    expect(await companyDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/geekwaycoreApp.company.delete.question/);
