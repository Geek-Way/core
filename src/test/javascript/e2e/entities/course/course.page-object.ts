...
export class CourseDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('geekwaycoreApp.course.delete.question'));
...
export default class CourseComponentsPage {
  ...
  async deleteCourse() {
    ...
    expect(await courseDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/geekwaycoreApp.course.delete.question/);
