  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="geekwaycoreApp.company.home.createOrEditLabel">
            <Translate contentKey="geekwaycoreApp.company.home.createOrEditLabel">Create or edit a Company</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : companyEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="identifierLabel" for="company-identifier">
