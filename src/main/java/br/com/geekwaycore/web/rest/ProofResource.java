...
/**
 * REST controller for managing {@link br.com.geekwaycore.domain.Proof}.
 */
@RestController
@RequestMapping("/api")
public class ProofResource {
    ...
    public ResponseEntity<Proof> updateProof(@Valid @RequestBody Proof proof) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, proof.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Proof> getProof(@PathVariable Long id) {
